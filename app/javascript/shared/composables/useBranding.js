...
export function useBranding() {
  ...
  /**
   * Replaces "Alcruxia" in text with the installation name from global config
   * @param {string} text - The text to process
   * @returns {string} - Text with "Alcruxia" replaced by installation name
   */
  const replaceInstallationName = text => {
    ...
    return text.replace(/Alcruxia/g, installationName);
  };
